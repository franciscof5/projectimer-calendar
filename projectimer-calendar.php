...
/*
Plugin Name: Projectimer Calendar
Plugin URI: http://projectimer.com
Description: Projectimer is based on Calendar Archives, a visualization plugin for your WordPress site which creates yearly calendar for your posts. Create a new page (having 'no sidebars' layout) for your calendar archive and insert the code [calendar-archive] in the editor. Load this page and enjoy the view!
Version: 0.1
...
/*  
    Copyright 2016  Francisco Mat  (email : fmatelli@gmail.com)
...
class CalendarArchives
{
    ...
    function display()
    {
        ...
        if ($category)
        {
            ...
            //$conditions['post_author'] = 'post_author = 1 '; 
        }
